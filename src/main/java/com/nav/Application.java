...
import com.nav.domain.Domain;
import com.nav.domain.DomainRepository;
...
public class Application {
    ...
    CommandLineRunner init(DomainRepository domainRepository) {
        ...
        return args -> {
            ...
            Domain obj2 = domainRepository.findFirstByDomain("nav.com");
            System.out.println(obj2);

            //obj2.setDisplayAds(true);
            //domainRepository.save(obj2);

            //int n = domainRepository.updateDomain("nav.com", true);
